...
STREAM_LEN=200000    # Her bir dizi (sequence) uzunluğu (bit olarak)
NUM_SEQ=100            # Test edilecek toplam dizi sayısı
INPUT_FILE="../../../../results/sha512_test_data.txt" # Test edilecek dosya yolu

# Rapor için hedef dosya ismi
REPORT_DIR="./experiments/AlgorithmTesting"
REPORT_FILE="sha512_NIST_Report.txt"
